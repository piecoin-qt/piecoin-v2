...
{
    uiInterface.ThreadSafeMessageBox(str, _("Piecoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("Piecoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: pieconf.txt)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 40404 or testnet: 40406)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 40405 or testnet: 40407)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (filesystem::exists(GetDataDir() / strWalletFileName))
    {
        ...
        if (r == CDBEnv::RECOVER_OK)
        {
            ...
            uiInterface.ThreadSafeMessageBox(msg, _("Piecoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        }
    ...
    if (nLoadStakeDBRet != SDB_LOAD_OK)
    {
        ...
        else if (nLoadStakeDBRet == SDB_NONCRITICAL_ERROR)
        {
            ...
            strErrors << _("Error loading stake.dat: StakeDB requires newer version of Piecoin") << "\n";
        else if (nLoadStakeDBRet == SDB_NEED_REWRITE)
        {
            strErrors << _("StakeDB needed to be rewritten: restart Piecoin to complete") << "\n";
            printf("%s", strErrors.str().c_str());
            return InitError(strErrors.str());
        }
        else
