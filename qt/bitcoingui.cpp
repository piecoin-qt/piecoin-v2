...
void BitcoinGUI::createMenuBar()
{
    ...
    QLabel* pieCorner = new QLabel(w);
    pieCorner->setText("<html><head/><body><p><img src=\":/icons/piecoin-32\"/></p></body></html>");
    pieCorner->setAttribute(Qt::WA_TransparentForMouseEvents);
    layout->addWidget(pieCorner);
