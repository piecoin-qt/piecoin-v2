    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Piecoin address (e.g. 2XywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
    ...
    ui->labelBlockSize->setText(QString("0 PIE"));
#endif
