...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("piecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("piecoin-smsg-pow"); // Make this thread recognisable
...
int SecureMspiecrypt(SecureMessage& smsg, std::string& addressFrom, std::string& addressTo, std::string& message)
{
...
int SecureMsgSend(std::string& addressFrom, std::string& addressTo, std::string& message, std::string& sError)
{
    ...
    */
    ...
    if ((rv = SecureMspiecrypt(smsg, addressFrom, addressTo, message)) != 0)
    {
    ...
    } else
    {
        ...
        if ((rv = SecureMspiecrypt(smsgForOutbox, addressFrom, addressOutbox, message)) != 0)
        {
