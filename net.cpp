...
static const char *strDNSSeed[][2] = {
    {"primary", "piearmy.ml"},
    {"frankfurt", "frankfurt.piearmy.ml"},
    {"paris", "paris.piearmy.ml"},
    {"singapore", "singapore.piearmy.ml"},
    {"sydney", "sydney.piearmy.ml"},
    {"tokyo", "tokyo.piearmy.ml"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("piecoin-dnsseed");
