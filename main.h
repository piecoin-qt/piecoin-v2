...
static const unsigned int MIN_PEERS = 8; // Require a good connection to the network for staking.
static const unsigned int nHalvingPoint = 5;  //Years between halvings
static const int64_t MIN_TX_FEE = 10000;
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64_t MAX_MONEY = 4491264000 * COIN;
static const int64_t YEARLY_BLOCKCOUNT = 175320; //365.25 * 24 * 60 / 3

inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const unsigned int LOCKTIME_THRESHOLD = 1653223222; // Sun May 22 2022 12:40:22 UTC
...
inline int64_t PastDrift(int64_t nTime)   { return nTime - 12 * 60; } // up to 12 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 12 * 60; } // up to 12 minutes from the future
